...
class FetchData : ObservableObject{
    ...
    init(){
        ...
        let url = URL(string: "https://api.openweathermap.org/data/2.5/onecall?lat=40.025&lon=-75.2829&units=imperial&exclude=alerts,minutely,hourly&appid=84093e05f55a9182393f95986f3b9d57")!
